...
final class RequestProcessingUiSupport {
    ...
    static void addStyleClass(Node node, String... styleClasses) {
    ...
    static void setStateClass(Node node, List<String> stateClasses, String selectedClass) {
    ...
    static void applyMainStylesheet(Scene scene) {
