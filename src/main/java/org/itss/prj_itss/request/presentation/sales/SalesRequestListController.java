...
public class SalesRequestListController implements IViewController {
    ...
    private ReceivedRequestsApplicationService receivedRequestsService;
    ...
    private void initialize() {
        ...
        createRequestButton.setOnAction(event -> 
            org.itss.prj_itss.request.presentation.sales.create.CreateOrderRequestPopup.show(requestTable.getScene().getWindow(), this::reload)
        );
    }
    ...
    public void init(INavigator navigator, ApplicationContext context) {
        ...
        this.receivedRequestsService = context.receivedRequestsApplicationService();
        reload();
    }
    ...
    private void reload() {
        List<RequestRow> requestRows = receivedRequestsService.findRows();
    ...
    private HBox buildActionButtons(RequestRow row) {
        ...
        viewBtn.setOnAction(event ->
            org.itss.prj_itss.request.presentation.sales.view.ViewOrderRequestPopup.show(
        ...
        if (isPending) {
            ...
            editBtn.setOnAction(event -> {
                org.itss.prj_itss.request.presentation.sales.update.UpdateOrderRequestPopup.show(
                    requestTable.getScene().getWindow(),
                    row.requestId(),
                    ApplicationContext.getInstance(),
                    this::reload
        ...
        deleteBtn.setOnAction(event -> {
            ...
            confirm.showAndWait().ifPresent(response -> {
                if (response == javafx.scene.control.ButtonType.OK) {
                    boolean success = receivedRequestsService.deleteRequest(row.requestId());
                    if (success) {
                        reload();
                    } else {
