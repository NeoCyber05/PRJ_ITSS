...
import org.itss.prj_itss.order.presentation.ordering.OrderDetailPanel;
import org.itss.prj_itss.request.application.sales.AllocatedOrderRow;
...
public final class RequestDetailPopupController {
    ...
    private RequestDetailApplicationService detailService;
    ...
    void init(
        ...
        this.detailService = context.requestDetailApplicationService();
            ...
            cancelBtn.setOnAction(e -> {
                ...
                alert.showAndWait().ifPresent(response -> {
                    if (response == javafx.scene.control.ButtonType.OK) {
                        OrderCancellationApplicationService.CancellationResult result =
                            orderCancellationApplicationService.cancel(order.orderId());
                        if (!result.success()) {
                            return;
                        }
    ...
    private void hideOrderDetail() {
        ...
        if (currentSelectedOrder != null && currentSelectedRow != null) {
            AllocatedOrderRow refreshed = detailService.findOrderRow(currentSelectedOrder.orderId());
