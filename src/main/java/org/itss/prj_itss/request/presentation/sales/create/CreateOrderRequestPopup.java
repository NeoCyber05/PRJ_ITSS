...
public final class CreateOrderRequestPopup {
    ...
    public static void show(Window owner, Runnable onSave) {
        ...
        try {
            ...
            CreateOrderRequestController controller = loader.getController();
            controller.setDialog(dialog);
            controller.setOnSave(onSave);
            controller.init(null, org.itss.prj_itss.common.config.ApplicationContext.getInstance());
