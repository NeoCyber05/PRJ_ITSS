package org.itss.prj_itss.request.presentation.sales.create;
...
public class CreateOrderRequestController implements IViewController {
    ...
    public void init(org.itss.prj_itss.layout.INavigator navigator, org.itss.prj_itss.common.config.ApplicationContext context) {
        this.salesService = org.itss.prj_itss.common.config.ApplicationContext.getInstance().requestSalesApplicationService();
    ...
    private void submitRequest() {
        try {
            ...
            for (javafx.scene.Node node : itemsContainer.getChildren()) {
                ...
                MerchandiseOption m = salesService.findMerchandiseOptionByCode(code.trim());
                if (m == null) {
    ...
    private void setupRowListeners(HBox row) {
        ...
        codeField.textProperty().addListener((observable, oldValue, newValue) -> {
            ...
            MerchandiseOption m = salesService.findMerchandiseOptionByCode(newValue.trim());
            if (m != null) {
                codeField.setStyle(defaultStyle);
