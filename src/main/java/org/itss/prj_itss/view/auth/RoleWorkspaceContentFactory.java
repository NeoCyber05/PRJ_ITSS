    ...
    public static RoleWorkspaceContent create(AuthenticatedUser user) {
        ...
        return switch (roleType) {
            ...
            case SALES -> new RoleWorkspaceContent(
                ...
                "Tài khoản đã được xác thực đúng role. Module nghiệp vụ riêng cho bộ phận bán hàng đã được triển khai trong phiên bản này.",
                "Quyền chính: tạo và theo dõi yêu cầu đặt hàng, quản lý mặt hàng.",
                "Đã triển khai",
                List.of(
            ...
            case WAREHOUSE -> new RoleWorkspaceContent(
                ...
                "Tài khoản đã được xác thực đúng role. Module nghiệp vụ riêng cho bộ phận quản lý kho đã được triển khai trong phiên bản này.",
