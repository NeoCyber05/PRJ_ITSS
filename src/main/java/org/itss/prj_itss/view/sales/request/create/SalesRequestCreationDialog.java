...
public final class SalesRequestCreationDialog {

    private static final String VIEW_RESOURCE = "/org/itss/prj_itss/view/sales/request/create/sales-request-creation-dialog.fxml";
    private static final String MAIN_STYLESHEET = "/org/itss/prj_itss/styles/main-style.css";

    private SalesRequestCreationDialog() {
    }

    public static void show(Window owner, SalesRequestCreationController controller, Runnable onSave) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(Objects.requireNonNull(
                SalesRequestCreationDialog.class.getResource(VIEW_RESOURCE),
            ...
            var stylesheet = SalesRequestCreationDialog.class.getResource(MAIN_STYLESHEET);
