...
public final class UpdateOrderRequestView implements ViewLifecycle {
    ...
    private UpdateOrderRequestController controller;
    private Stage              stage;
    ...
    public void init(Stage stage, int requestId, UpdateOrderRequestController controller, Runnable onUpdateSuccess) {
        this.stage            = stage;
    ...
    private void setupTable() {
        ...
        List<MerchandiseOption> allMerchandise = controller.getMerchandiseOptions();
        setupCheckboxColumn();
    ...
    private void loadData() {
        ...
        RequestFormView form = controller.loadRequest(currentRequestId);
        if (form == null) return;
    ...
    private void saveChanges() {
        ...
        ActionResult result = controller.updateRequest(currentRequestId, requestItems);
        if (result.success()) {
            Alert alert = new Alert(Alert.AlertType.INFORMATION, result.message(), ButtonType.OK);
