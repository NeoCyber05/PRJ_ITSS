...
public final class SalesRequestListView implements ViewLifecycle {
    ...
    private UpdateOrderRequestController updateController;
    ...
    private void initialize() {
        ...
        createRequestButton.setOnAction(event -> 
            org.itss.prj_itss.view.sales.request.CreateOrderRequestPopup.show(requestTable.getScene().getWindow(), createController, this::reload)
        );
    }
    ...
    public void init(
            ...
            UpdateOrderRequestController updateController,
    ...
    private HBox buildActionButtons(RequestRow row) {
        ...
        viewBtn.setOnAction(event ->
            org.itss.prj_itss.view.sales.request.ViewOrderRequestPopup.show(
        ...
        if (isPending) {
            ...
            editBtn.setOnAction(event -> {
                org.itss.prj_itss.view.sales.request.UpdateOrderRequestPopup.show(
                    requestTable.getScene().getWindow(),
                    row.requestId(),
                    updateController,
                    this::reload
