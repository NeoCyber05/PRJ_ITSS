...
public final class UpdateOrderRequestPopup {
    ...
    public static void show(
            Window owner,
            int requestId,
            UpdateOrderRequestController controller,
            Runnable onUpdateSuccess
    ) {
        Stage dialog = createDialog(owner);
        BorderPane root = loadRoot(dialog, requestId, controller, onUpdateSuccess);
    ...
    private static BorderPane loadRoot(
        ...
        try {
            ...
            view.init(dialog, requestId, controller, onUpdateSuccess);
