...
public final class ViewOrderRequestPopup {
    ...
    public static void show(Window owner, int requestId, ViewOrderRequestController controller) {
        Stage dialog = createDialog(owner);
        BorderPane root = loadRoot(dialog, requestId, controller);
    ...
    private static BorderPane loadRoot(Stage dialog, int requestId, ViewOrderRequestController controller) {
        try {
            ...
            ViewOrderRequestView view = loader.getController();
            view.init(dialog, requestId, controller);
