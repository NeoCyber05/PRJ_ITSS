...
public final class DetailNotificationPopupView {
    ...
    public void init(OrderCancellationLayoutView layoutView) {
        ...
        if (layoutView != null && layoutView.getCurrentViewModel() != null) {
            subtitleLabel.setText("Đơn hàng: " + layoutView.getCurrentViewModel().cancelledOrderCode());
        }
        render();
    }
    ...
    private void handleCloseAction() {
        if (layoutView != null) {
            ...
            layoutView.showFeedback("Xử lý gửi đơn thành công.", OrderCancellationLayoutView.FeedbackKind.SUCCESS);
    ...
    private void render() {
        ...
        container.getChildren().setAll(
            layoutView.getCurrentPreviewOrders().stream()
                .map(this::buildSubmittedOrderCard)
                .toList()
        );
    }
