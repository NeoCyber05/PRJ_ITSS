...
public final class UpdateOrderRequestPopup {
    ...
    private UpdateOrderRequestPopup() {
    }
    ...
    public static void show(
            ...
            Runnable onUpdateSuccess
    ) {
        Stage dialog = createDialog(owner);
        BorderPane root = loadRoot(dialog, requestId, context, onUpdateSuccess);
    ...
    private static BorderPane loadRoot(
            Stage dialog,
            int requestId,
            ApplicationContext context,
            Runnable onUpdateSuccess
        ...
        try {
            ...
            UpdateOrderRequestController controller = loader.getController();
            controller.init(dialog, requestId, context, onUpdateSuccess);
