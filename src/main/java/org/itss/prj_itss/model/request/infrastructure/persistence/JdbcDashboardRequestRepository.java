...
public class JdbcDashboardRequestRepository extends JdbcRepositorySupport implements DashboardRequestPort {
    ...
    public Map<Integer, Integer> countItemTypesByRequestIds(Set<Integer> requestIds) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("JdbcDashboardRequestRepository.countItemTypesByRequestIds: " + e.getMessage());
        }
        return counts;
    }
    ...
    public Map<Integer, LocalDate> findEarliestDeliveryDatesByRequestIds(Set<Integer> requestIds) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("JdbcDashboardRequestRepository.findEarliestDeliveryDatesByRequestIds: " + e.getMessage());
        }
        return dates;
    }
