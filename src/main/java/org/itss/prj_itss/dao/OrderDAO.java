...
public class OrderDAO extends BaseDAO implements IOrderDAO {
    ...
    public List<OrderMerchandise> findItemsByOrderId(int orderId) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("OrderDAO.findItemsByOrderId: " + e.getMessage());
        }
        return list;
    }
    ...
    public int create(Order order) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("OrderDAO.create: " + e.getMessage());
        }
        return -1;
    }
    ...
    public boolean addItem(OrderMerchandise item) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("OrderDAO.addItem: " + e.getMessage());
        }
        return false;
    }
