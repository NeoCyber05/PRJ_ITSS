...
public class SiteDAO extends BaseDAO implements ISiteDAO, IInventoryDAO {
    ...
    public List<Site> findAll() {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql);
            ...
            System.err.println("SiteDAO.findAll: " + e.getMessage());
        }
        return list;
    }
    ...
    public Site findById(int id) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("SiteDAO.findById: " + e.getMessage());
        }
        return null;
    }
    ...
    public Site findBySiteCode(String siteCode) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("SiteDAO.findBySiteCode: " + e.getMessage());
        }
        return null;
    }
    ...
    public int countAll() {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql);
            ...
            System.err.println("SiteDAO.countAll: " + e.getMessage());
        }
        return 0;
    }
    ...
    public Map<Integer, Integer> getInventoryBySiteId(int siteId) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("SiteDAO.getInventoryBySiteId: " + e.getMessage());
        }
        return map;
    }
    ...
    public int getStockQuantity(int siteId, int merchandiseId) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("SiteDAO.getStockQuantity: " + e.getMessage());
        }
        return 0;
    }
    ...
    public int getTotalStock(int merchandiseId) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("SiteDAO.getTotalStock: " + e.getMessage());
        }
        return 0;
    }
    ...
    public int countMerchandiseAtSite(int siteId) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("SiteDAO.countMerchandiseAtSite: " + e.getMessage());
        }
        return 0;
    }
