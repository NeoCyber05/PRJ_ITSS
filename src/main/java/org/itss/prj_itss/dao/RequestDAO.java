...
public class RequestDAO extends BaseDAO implements IRequestDAO {
    ...
    public List<Request> findAll() {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql);
            ...
            System.err.println("RequestDAO.findAll: " + e.getMessage());
        }
        return list;
    }
    ...
    public Request findById(int id) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("RequestDAO.findById: " + e.getMessage());
        }
        return null;
    }
    ...
    public List<RequestMerchandise> findItemsByRequestId(int requestId) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("RequestDAO.findItemsByRequestId: " + e.getMessage());
        }
        return list;
    }
    ...
    public int countItemTypes(int requestId) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("RequestDAO.countItemTypes: " + e.getMessage());
        }
        return 0;
    }
    ...
    public LocalDate getEarliestDeliveryDate(int requestId) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("RequestDAO.getEarliestDeliveryDate: " + e.getMessage());
        }
        return null;
    }
    ...
    public boolean updateStatus(int requestId, String newStatus) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("RequestDAO.updateStatus: " + e.getMessage());
        }
        return false;
    }
