...
import org.itss.prj_itss.order.application.OrderRow;
...
public class OrderManagementController implements IViewController {
    ...
    public void init(INavigator navigator, ApplicationContext context) {
        ...
        this.orderManagementApplicationService = context.orderManagementApplicationService();
        reload();
    }

    private void reload() {
        rows.setAll(orderManagementApplicationService.findRows());
        applyFilters();
    }
