package org.itss.prj_itss.warehouse.presentation.confirm_arrival;
...
import org.itss.prj_itss.warehouse.domain.InspectionResult;
import org.itss.prj_itss.catalog.application.CatalogUseCase;
import org.itss.prj_itss.site.application.SiteUseCase;
import org.itss.prj_itss.warehouse.application.WarehouseReceivingUseCase;
import org.itss.prj_itss.warehouse.application.WarehouseReceivingUseCase.ConfirmationResult;
import org.itss.prj_itss.warehouse.application.WarehouseReceivingUseCase.InspectionItemInput;
...
public final class ConfirmOrderArrivalController implements IViewController {
    ...
    private WarehouseReceivingUseCase warehouseReceivingUseCase;
    private SiteUseCase siteService;
    private CatalogUseCase merchandiseService;
    ...
    public void init(INavigator navigator, ApplicationContext context) {
        this.warehouseReceivingUseCase = context.warehouseReceivingUseCase();
        this.siteService = context.siteUseCase();
        this.merchandiseService = context.catalogUseCase();
        loadInboundOrders();
    }
    ...
    private void loadInboundOrders() {
        List<Order> inboundOrders = warehouseReceivingUseCase.findInboundOrders();
    ...
    private void loadOrderItems(Order order) {
        List<OrderMerchandise> items = warehouseReceivingUseCase.findItemsByOrderId(order.getId());
    ...
    private void handleConfirmArrival() {
        ...
        ConfirmationResult result = warehouseReceivingUseCase.confirmArrival(
            selectedOrder.getId(),
            itemInputs,
