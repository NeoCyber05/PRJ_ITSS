...
public class JdbcSiteRepository extends JdbcRepositorySupport implements SiteRepository, InventoryRepository {
    ...
    public JdbcSiteRepository(org.itss.prj_itss.common.config.ConnectionProvider connectionProvider) {
    ...
    public List<Site> findAll() {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql);
            ...
            System.err.println("JdbcSiteRepository.findAll: " + e.getMessage());
        }
        return list;
    }
    ...
    public Site findById(int id) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("JdbcSiteRepository.findById: " + e.getMessage());
        }
        return null;
    }
    ...
    public Site findBySiteCode(String siteCode) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("JdbcSiteRepository.findBySiteCode: " + e.getMessage());
        }
        return null;
    }
    ...
    public int countAll() {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql);
            ...
            System.err.println("JdbcSiteRepository.countAll: " + e.getMessage());
        }
        return 0;
    }
    ...
    public Map<Integer, Integer> getInventoryBySiteId(int siteId) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("JdbcSiteRepository.getInventoryBySiteId: " + e.getMessage());
        }
        return map;
    }
    ...
    public int getStockQuantity(int siteId, int merchandiseId) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("JdbcSiteRepository.getStockQuantity: " + e.getMessage());
        }
        return 0;
    }
    ...
    public int getTotalStock(int merchandiseId) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("JdbcSiteRepository.getTotalStock: " + e.getMessage());
        }
        return 0;
    }
    ...
    public int countMerchandiseAtSite(int siteId) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("JdbcSiteRepository.countMerchandiseAtSite: " + e.getMessage());
        }
        return 0;
    }
