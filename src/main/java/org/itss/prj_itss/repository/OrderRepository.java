...
public class OrderRepository extends RepositorySupport implements IOrderRepository {

    public OrderRepository(org.itss.prj_itss.common.config.IConnectionProvider connectionProvider) {
