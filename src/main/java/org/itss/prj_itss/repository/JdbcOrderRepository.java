...
public class JdbcOrderRepository extends JdbcRepositorySupport implements OrderRepository {
    ...
    public JdbcOrderRepository(org.itss.prj_itss.common.config.ConnectionProvider connectionProvider) {
    ...
    public List<Order> findAll() {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql);
            ...
            System.err.println("JdbcOrderRepository.findAll: " + e.getMessage());
        }
        return list;
    }
    ...
    public Order findById(int id) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("JdbcOrderRepository.findById: " + e.getMessage());
        }
        return null;
    }
    ...
    public List<OrderMerchandise> findItemsByOrderId(int orderId) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("JdbcOrderRepository.findItemsByOrderId: " + e.getMessage());
        }
        return list;
    }
    ...
    public int create(Order order) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("JdbcOrderRepository.create: " + e.getMessage());
        }
        return -1;
    }
    ...
    public boolean addItem(OrderMerchandise item) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("JdbcOrderRepository.addItem: " + e.getMessage());
        }
        return false;
    }
    ...
    public boolean updateStatus(int orderId, String newStatus) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("JdbcOrderRepository.updateStatus: " + e.getMessage());
        }
        return false;
    }
