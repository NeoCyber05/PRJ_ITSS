...
public class JdbcMerchandiseRepository extends JdbcRepositorySupport implements MerchandiseRepository {
    ...
    public JdbcMerchandiseRepository(org.itss.prj_itss.common.config.ConnectionProvider connectionProvider) {
    ...
    public List<Merchandise> findAll() {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql);
            ...
            System.err.println("JdbcMerchandiseRepository.findAll: " + e.getMessage());
        }
        return list;
    }
    ...
    public Merchandise findById(int id) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("JdbcMerchandiseRepository.findById: " + e.getMessage());
        }
        return null;
    }
    ...
    public Merchandise findByCode(String code) {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql)) {
            ...
            System.err.println("JdbcMerchandiseRepository.findByCode: " + e.getMessage());
        }
        return null;
    }
    ...
    public int countAll() {
        ...
        try (PreparedStatement ps = getConnection().prepareStatement(sql);
            ...
            System.err.println("JdbcMerchandiseRepository.countAll: " + e.getMessage());
        }
        return 0;
    }
